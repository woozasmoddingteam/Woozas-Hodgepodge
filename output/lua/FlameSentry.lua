...
kConfusedFlameSentryBaseROF = 0.20
...
FlameSentry.kFov = 140
FlameSentry.kMaxPitch = 70 -- 140 total
...
if Server then
    ...
    function FlameSentry:FireBullets()
       ...
       self.timeOfLastPrimaryAttack = Shared.GetTime()
        ...
        --         --    -- self:GetOwner():CreatePredictedProjectile("Grenade", startPoint, spreadDirection * 2, 0.7, 0.45)
        --         --    -- CreateEntity(Grenade.kMapName, trace.entity:GetOrigin(), 1)
        --         --    _CreateClusterFragment(self, self, nil, nil, nil, trace.entity)
        --         -- end
